# Generated by Django 2.0.2 on 2018-04-06 14:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('manager', '0005_auto_20180308_1821'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='manager.Order')),
                ('polymorphic_ctype', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='polymorphic_manager.orderitem_set+', to='contenttypes.ContentType')),
